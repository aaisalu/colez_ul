...
:pyProj
    ...
    echo    Press 4 = Extract Wi-Fi Password
    echo    [90mPress 0 = Depart[0m
    ...
    :wifiPass
        @echo off
        echo[
        cmd /k "cd %~dp0\venv\Scripts & activate & cd /d %~dp0\modules & python wifi_password.py & cd /d%~dp0\venv\Scripts & deactivate.bat & exit"
        pause
        goto:pyProj
